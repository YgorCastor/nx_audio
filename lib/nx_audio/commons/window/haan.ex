defmodule NxAudio.Commons.Window.Hann do
  import Nx.Defn
  ...
  """
  defn create(opts \\ []) do
    opts = keyword!(opts, window_length: 1, periodic: 1)
    window_length = opts[:window_length]
    periodic = opts[:periodic]

    # For periodic windows, we compute N+1 points and discard the last one
    computation_length = if periodic == 1, do: window_length + 1, else: window_length
